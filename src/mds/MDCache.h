...
enum {
  ...
  l_mdss_ireq_quiesce_subvolume,
  l_mdss_ireq_quiesce_subvolume_inode,
...
private:
  ...
  class C_MDS_QuiesceSubvolume : public MDSInternalContext {
  public:
    C_MDS_QuiesceSubvolume(MDCache *c, Context* _finisher=nullptr) :
      MDSInternalContext(c->mds), cache(c), finisher(_finisher) {}
    ~C_MDS_QuiesceSubvolume() {
      if (finisher) {
